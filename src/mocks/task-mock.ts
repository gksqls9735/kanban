...
import { options, priorityHigh, priorityLow, priorityMedium, priorityUrgent, singleOption1, statusCompleted, statusInProgress, statusWaiting } from "./select-option-mock";
